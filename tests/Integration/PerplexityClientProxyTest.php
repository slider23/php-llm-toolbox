...
class PerplexityClientProxyTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->apiKey = getenv('PERPLEXITY_API_KEY') ? $_ENV['PERPLEXITY_API_KEY'] : null;
    ...
    public function testSingleRequestViaProxy()
    {
        ...
        $this->assertEquals('perplexity', $response->vendor, "Response vendor should be 'perplexity'.");
